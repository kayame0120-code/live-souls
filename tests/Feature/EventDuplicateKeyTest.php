...
class EventDuplicateKeyTest extends TestCase
{
    ...
    {
        $this->service->create('Xツアー', '2026-07-29', '13:30', $this->venueId);
        $this->service->create('Xツアー', '2026-07-29', '18:00', $this->venueId);
    ...
    {
        $this->service->create('Xツアー', '2026-07-29', null, $this->venueId);
